/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/array-type, @typescript-eslint/consistent-type-imports, import/order */
// Copied from https://unpkg.com/browse/@types/node-fetch@2.6.4/index.d.ts
// The only modifications are:
// - Add `static json()` to `class Response`
// - Remove FormData
// - Allow null for `body` in both Request and Response
